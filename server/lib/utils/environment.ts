...
export const isExpressProduction =
  expressEnv === "production" || expressNodeEnv === "production"
...
export const ssoClientInternalSecret =
  process.env.EXPRESS_SSO_CLIENT_INTERNAL_SECRET
...
export const accessTokenExpiresIn =
  process.env.EXPRESS_GORTH_ACCESS_TOKEN_EXPIRES_IN
export const refreshTokenExpiresIn =
  process.env.EXPRESS_GORTH_REFRESH_TOKEN_EXPIRES_IN
...
export const billingSubscriptionUrl =
  process.env.EXPRESS_BILLING_SUBSCRIPTION_URL
